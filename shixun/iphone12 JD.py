...
for k in range(101):
    url='https://club.jd.com/comment/productPageComments.action?callback=fetchJSON_comment98&productId=100016034394&score=0&sortType=5&page='+str(k)+'&pageSize=10&isShadowSku=0&fold=1'
    headers={
    ...
    'Referer': 'https://item.jd.com/100016034394.html',
